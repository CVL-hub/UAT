...
#        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)        
    ...
    def __init__(self,block, layers, mode='rgb', baseWidth=26, scale=4, num_classes=1000):
        self.inplanes = 64
        super(Res2Net, self).__init__()
        self.baseWidth = baseWidth
        self.scale = scale
...
def res2net50_v1b_26w_4s( mode, pretrained=False, **kwargs):
    """Constructs a Res2Net-50_v1b_26w_4s lib.
    Args:
        pretrained (bool): If True, returns a lib pre-trained on ImageNet
    """
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], mode, baseWidth=26, scale=4, **kwargs)
    if pretrained:
